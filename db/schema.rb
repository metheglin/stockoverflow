...
ActiveRecord::Schema[8.1].define(version: 2026_02_16_122246) do
  create_table "cash_flow_metrics", force: :cascade do |t|
    t.decimal "cash_conversion_cycle", precision: 10, scale: 4
    ...
    t.index ["company_id", "fiscal_year", "fiscal_period"], name: "idx_cf_metrics_company_year_period", unique: true
  ...
  create_table "financial_statements", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["company_id", "fiscal_year", "fiscal_period"], name: "idx_fin_stmt_company_year_period", unique: true
  ...
  create_table "growth_metrics", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["company_id", "fiscal_year", "fiscal_period"], name: "idx_growth_metrics_company_year_period", unique: true
  ...
  create_table "profitability_metrics", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["company_id", "fiscal_year", "fiscal_period"], name: "idx_profit_metrics_company_year_period", unique: true
    t.index ["company_id"], name: "index_profitability_metrics_on_company_id"
  end

  create_table "stock_prices", force: :cascade do |t|
    t.decimal "adjusted_close", precision: 15, scale: 4
